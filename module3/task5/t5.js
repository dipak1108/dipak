...
// Loop through picArray to create and populate articles
picArray.forEach(item => {
  console.log(item.image);
    ...
    // Create and add a <h2> for the title
    const heading = document.createElement('h2');
    heading.textContent = item.title;
    article.appendChild(heading);

    // Create and add a <figure> containing the image and caption
    ...
    // Create and add a <p> for the text
